 ...
 * This file demonstrates how to integrate Questnook with a web frontend
 */

// For React/Vue/Angular applications
export class QuestnookClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new QuestnookClient(provider, contractAddress);
